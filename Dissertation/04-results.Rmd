...
table%>%arrange(subregion)%>% knitr::kable(caption = "South America Atlantic coast - Number of SLIPs by region",
                           col.names = c('Region name','Number of Sea level Indicators','Radiometric dating','MIS assignment (Uniform)'), escape = FALSE, booktabs=T, digits = 1) %>%add_header_above(c(" "=2, "Origin age calculation" = 2)) %>% kable_styling(font_size = 10,latex_options = c("striped", "scale_down","HOLD_position"))
...
table%>%arrange(subregion)%>% knitr::kable(caption = "South America Pacific coast - Number of SLIPs by region",
                           col.names = c('Region name','Number of Sea level Indicators','Radiometric dating','MIS assignment (Uniform)'), escape = FALSE, booktabs=T, digits = 1) %>%add_header_above(c(" "=2, "Origin age calculation" = 2)) %>% kable_styling(font_size = 10,latex_options = c("striped", "scale_down","HOLD_position"))
